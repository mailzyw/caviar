...
public class RequestContextManager {
    ...
    public void bindRequestContext(long requestId, RequestContext context){
        ...
        LOGGER.info("[request manager] bind context succeed. requestId:{}, context:{}", requestId, context);
    }
    ...
    public void cleanRequestContext(long requestId){
        ...
        LOGGER.info("[request manager] clean context succeed. requestId:{}, context:{}", requestId, context);
    }
