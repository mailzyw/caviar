...
public class SessionManagerImpl implements SessionManager{
    ...
    public SessionContext bindSessionContext(long index, SessionContext session) {
        ...
        LOGGER.debug("[session manager] bind session succeed. mapSize:{}, index:{}, session:{}", index2Session.size(), index, session);
        return result;
    }
    ...
    public void cleanSessionContext(long index) {
        ...
        LOGGER.debug("[session manager] clean session by index succeed. mapSize:{}, index:{}, session:{}", index2Session.size(), index, session);
    }
